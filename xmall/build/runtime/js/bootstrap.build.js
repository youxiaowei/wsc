...
define('libs/fastclick-custom',['fastclick'], function(FastClick){
...
define('loader',['require'],function(require){
...
define('components/BaseView',['underscore', 'backbone'], function(_, Backbone){
 ...
 * MIT License
*/
define('libs/querystring',[],function(){
  var querystring = {
...
define('pages/PageView',['require','backbone','underscore','../components/BaseView','../libs/querystring'],function(require) {
...
define('Application',['require','underscore','backbone','./loader','./pages/PageView'],function(require) {
  var _ = require('underscore');
  var Backbone = require('backbone');
...
define('components/FragmentView',['require','./BaseView','../loader'],function(require){
...
define('components/NavView',['./BaseView'], function(BaseView){
...
// ```
////
define('components/ImageView',['./BaseView'], function(BaseView){
...
define('components/VideoView',['./BaseView'], function(BaseView){
...
// }
// ```
define('components/ButtonView',['./BaseView'], function(BaseView){
...
// ```
////
define('components/CarouselView',[
  './SlickView'
], function(SlickView){
...
// ```
////
define('components/PosterView',['./SlickView'], function(SlickView){
...
define('components/SegmentedView',['underscore', './BaseView'], function(_, BaseView){
...
(function (factory) {
  ...
  // AMD
    ...
    define('backbone.paginator',["underscore", "backbone"], factory);
  }
  // Browser
...
// ## 样式
define('components/SearchView',['./BaseView'], function(BaseView){
...
define('components/FormView',['./BaseView'], function(BaseView){
...
define('components/MenuView',['underscore', './BaseView'], function(_, BaseView){
 ...
 */
define('pages/TabBarView',['require','../components/BaseView','./PageView'],function(require){
 ...
 *
 */
define('pages/NavigationView',['require', '../components/BaseView', './PageView'], function(require, BaseView, PageView){
...
define('models/StaticCollection',['backbone'], function(Backbone){
...
define('models/BaseCollection',['backbone', 'backbone.paginator'], function(Backbone, PageableCollection){
 ...
 * 远端collection，根据id适配
 */
define('models/RemoteCollection',['./BaseCollection','underscore'], function(BaseCollection, _) {
 ...
 */
define('library',['require','./components/FragmentView','./components/NavView','./components/TextView','./components/TitleView','./components/ImageView','./components/VideoView','./components/ButtonView','./components/HTMLView','./components/CarouselView','./components/GalleryView','./components/PosterView','./components/SegmentedView','./components/ListView','./components/SearchView','./components/FormView','./components/MenuView','./pages/PageView','./pages/TabBarView','./pages/NavigationView','./models/StaticCollection','./models/RemoteCollection','./extension-library'],function(require){
...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define('view-hierachy',['exports', 'underscore', 'backbone'], function(exports, _, Backbone) {
...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define('view-modal',['exports', 'underscore', 'backbone'], function(exports, _, Backbone) {
      return factory(root, _, Backbone);
    });
...
//
define('jquery.animate',['require','underscore','jquery'],function(require){
...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define('library-extend',['exports', 'underscore', './library'], function(exports, _, library) {
