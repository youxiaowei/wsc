define(['./PageView', 'require', '../libs/canlendar' ], function(PageView, require, canlendar){
    return PageView.extend({
        ...
        showGetIntegralDetail: function(json){
            ...
            for(var i=0; i<json.length; i++) {
                ...
                if (jsonRow.point != undefined) {
                    creditdetaillistviewDivHtml += '<p align="center"><span>' + jsonRow.point + '</span>储粮通宝</p>';
                }
        ...
        /*onError: function() {
         var blankicon = $(
         "<div class = 'icomoon-without add-blank-leaving-icon'></div><div class = 'add-blank-leaving-words'>获取储粮通宝失败~</div>"
         );
        ...
        /*onResume: function() {
         ...
         var blankicon = $(
         "<div class = 'icomoon-without add-blank-leaving-icon'></div><div class = 'add-blank-leaving-words'>您还没有相关储粮通宝哟~</div>"
         );
