...
//                arguments);
        ...
        setActive: function(index) {
            ...
            var str = "#my-navigate/package-order-list?list_type=" + index;
        ...
        initData: function() {
            this.listCollection = this.findComponent('AllOrderListView').collection;
        ...
        onRowSelect: function(e) {
            ...
            var suitId = this.orderInfo.get('suitId');
            ...
            if($(e.target)
                ...
                return;
            }else if($(e.target).data('name') == 'checkLog'){
                //查看物流
                ...
                return;
            }else if($(e.target).data('name') == 'getPackage'){
            	Backbone.history.navigate(
                        "#my-navigate/bill-lading?orderId=" +orderId, {
                            trigger: true
                    });
            	return;
            }else if($(e.target).data('name') == 'cancelPayMoney'){
            	if(orderStatus == 6){
            	...
            	return;
            }else if($(e.target).data('name') == 'showList'){
            	Backbone.history.navigate(
            ...
            var logisId = this.orderInfo.get('logisticId');
            Backbone.history.navigate(
                "#my-navigate/confirm-order-completion?orderId=" +orderId+"&suitId="+ suitId, {
                    trigger: true
                })
        },
        //去申请售后
